...
BLOG_AUTHOR = "Max Sych"  # (translatable)
BLOG_TITLE = "Some info about myself"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "https://dubass83.xyz/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "https://dubass83.xyz/"
BLOG_EMAIL = "makssych@gmail.com"
BLOG_DESCRIPTION = "This is my summary for people who want to know more about me."  # (translatable)
